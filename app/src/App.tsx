...
// Instalación: el montaje (hardware DIY, riego, tablero) y lo que falta comprar.
// Ojo: "Econometría › Instalaciones" es otra cosa —el equipamiento que amortiza.
