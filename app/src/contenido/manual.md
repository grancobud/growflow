...
serlo a pedido de quienes lo usan todos los días. La razón es simple: nadie abre la sede para enterarse de
...
Digamos que el lote **LOTE-001** tiene **45 g** disponibles.

> **Por qué importa el lote:** si mañana viene una inspección y pregunta de dónde
> salieron los 20 g de Marta, la respuesta es "del lote LOTE-001, que vino de la
...
1. Descuenta los 20 g del lote LOTE-001, que queda en 25 g.
...
- **Los gramos vuelven al lote.** Si eran 20 g del LOTE-001, el lote vuelve a 45 g
...
|---|---|---|---|
| **antiguo** | Socio desde el inicio | *(a definir)* | *(a definir)* |
| **frecuente** | Por volumen y frecuencia de retiro | *(a definir)* | *(a definir)* |
| **nuevo** | Reciente u ocasional | *(a definir)* | *(a definir)* |

⚠️ **Los importes los define la asociación y se cargan en la app**, en
`O.N.G. › Asociados › tarifas`. Hasta que estén cargados, la tabla está vacía y
el sistema no sugiere ningún aporte. No hay valores "de fábrica" a propósito:
un número puesto por el sistema se termina cobrando sin que nadie lo haya
decidido.
...
| | **COMPRA** · entra material, sale plata | **ENTREGA** · sale material, entra plata |
|---|---|---|
| **1** | Comprobante del proveedor — factura · ticket · remito | La entrega (dispensa) — descuenta del lote |
| **2** | **El lote** — recién acá se puede entregar | **Recibo del aporte** — «Comprobante de dispensa» |
| **3** | El pago — egreso de caja | El reporte de seguimiento — sin él no puede volver a retirar |
...
3. **Número** — tal como lo emitió el organismo, con letras y todo. Las actas
   de la IGJ tienen la forma `ACTA-AAAA-NNNNNNNNN-APN-DTD#JGM`: se copia
   completa, sin acortarla.
