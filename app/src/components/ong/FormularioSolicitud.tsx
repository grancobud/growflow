...
// limpiar en Panacea. Un solo circuito de alta, no dos.
//
    ...
    <div className="mt-3 rounded-lg border border-[#1d3a5a] bg-[#38bdf8]/[0.06] p-3">
      ...
      <div className="mt-2.5 space-y-2.5">
        ...
        {/* «opcional · pago» se mantiene aunque el texto nuevo no lo diga.
            ...
            boton para no pelearse con la redaccion de Cristian. */}
        {atajo && (
          <div>
            <p className="text-[11px] text-[#c9cabf]">
...
export function FormularioSolicitud() {
  ...
  // se habilitaba. Lo pidió Panacea y tienen razón: es un cuello de botella.
  //
  ...
  const enviar = async () => {
    ...
    try {
      setToken(await solicitudesService.crear({
        ...
        // EL MANDATO SALIÓ DEL FORMULARIO (31/08/2026, pedido de Cristian):
  ...
  return (
    <div className="space-y-3">
        ...
        {tieneRepro === false && (
          <div className="mt-3">
            ...
            {/* ACÁ IBA EL AVISO DE QUE LA ENTREGA NO ESTÁ AMPARADA.
                Lo sacó Panacea el 31/08/2026, junto con la explicación del
      ...
      {/* 4. Términos y condiciones — UN SOLO ACEPTAR.
          Lo pidió Cristian (Panacea) el 31/08/2026: que sea «como términos y
