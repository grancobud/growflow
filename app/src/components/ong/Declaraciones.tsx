    ...
    <div className="space-y-4">
      ...
      <div className={card}>
        ...
        <div className="rounded-lg bg-[#15151d] border border-[#1f1f2b] p-3 mt-3">
          <div className="text-[10px] uppercase tracking-[0.12em] text-[#8a8a9c] mb-2">
            ...
            {traslados.map(t => {
              ...
              return (
                <div key={t.id} className="rounded-lg bg-[#15151d] border px-3 py-2"
                  ...
                  <p className="text-[10.5px] text-[#8a8a9c] mt-1 truncate">
...
function Dato({ t, v }: { t: string; v: string }) {
  return (
    <div>
      <div className="text-[9.5px] uppercase tracking-[0.1em] text-[#8a8a9c]">{t}</div>
