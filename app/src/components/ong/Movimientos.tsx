...
//
// El diseño sale de la hoja FINANZAS de la planilla, que es donde Panacea mira
  ...
  return (
    <div className="space-y-3">
      ...
      {r.asientos === 0 ? (
        ...
        // más ancho», sin decir cuál. En Panacea, entrar un martes cualquiera
      ...
      <div className={tarjeta}>
        ...
        {/* «Sin discriminar» aparece cuando hay, y con eso las tarjetas vuelven
            ...
            Las dos de arriba solas escondían 92 asientos por $17,7M en Panacea
        ...
        {/* EL TOTAL, ESCRITO.
            ...
            no son un saldo. En Panacea da $24.000 + $589.500 − $592.821: quien
            mira las dos primeras se lleva $613.500 cuando lo que hay es
            $20.679, treinta veces menos. El total va escrito para que nadie
