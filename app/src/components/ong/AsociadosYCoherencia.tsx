...
export function Coherencia(props: {
  ...
  const datosCadena: DatosCadena = {
    ...
    //
    // Sumaba todos los lotes. En Panacea eso son 4.837 g de cultivo propio sin
    // cosecha registrada contados como compra a terceros: la nota decía
    // «9.147 g de proveedores» cuando de proveedores eran 4.283. Esta pantalla
    ...
    // en Panacea el cultivo propio entró como 46 órdenes de compra a sí mismos
    // por $26.376.500, de las cuales se «pagaron» $150.000. Eso daba
    // $26.226.500 de deuda con uno mismo, que la cadena sumaba al costo: $101 M
    ...
    ...(() => {
      ...
      // gramos —incluidos los 2.424 g que se entregan sin cargo— hace ver un
      ...
      // hay 4 asientos de merma y consumo interno con $660.000 y cero gramos, y
      ...
      // por gramo de $9.732 a $9.871 sobre gramos que no existen.
