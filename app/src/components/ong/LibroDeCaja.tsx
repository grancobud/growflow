    ...
    <>
      ...
      <div id="caja" className={tarjeta}>
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <div className="w-full sm:w-auto sm:ml-auto flex gap-2">
            {/* La plata que pasa del banco a la mano. Eran DOS asientos a mano
                ...
                −$10,2M contra $692.000 de traspasos registrados. */}
        ...
        {/* DOS columnas en el telefono y tres desde `sm`.
            ...
            «$75.840.016» no entra ni achicado a 14 px. Tres columnas de plata no
...
function ModalAsiento({ form, setForm, onCambio }: {
  ...
  // TODA SALIDA DE PLATA POR EL MISMO BOTÓN (01/09/2026, pedido de Cristian).
  //
  ...
  const guardar = async () => {
    ...
    try {
      ...
      // lado. El 23/08/2026 eso dejó TRES asientos idénticos de $40.000 en el
      // libro real de Panacea, cargados uno atrás del otro.
      //
