...
// histórico muestra: sobre $62,9M movidos el neto acumulado es de $587.500, un
...
/** Para los ejes: $12.400.000 no entra en una etiqueta de gráfico. */
  ...
  return (
    <div className="space-y-3">
      <div className={tarjeta}>
        ...
        {/* El margen sobre lo movido dice más que el resultado solo: $587.500
