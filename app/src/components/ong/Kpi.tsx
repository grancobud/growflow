 ...
 * corresponde: en `$1.234.567` no hay unidad que atenuar.
 */
  ...
  return (
    <div className={`min-w-0 h-full min-h-[72px] flex flex-col items-center justify-center text-center
      ...
      {/* EL NUMERO NUNCA SE TRUNCA NI SE PARTE.
          Con `truncate` a 20 px, «$73.850.000» salia «$73.8…»: un importe
          ...
          medido en el telefono el 01/09/2026, «$75.840.016» salia «$75.840.0» /
