    ...
    <div className="rounded-xl bg-[#101016] border border-[#1f1f2b] overflow-hidden flex flex-col h-full">
      <div className="px-4 py-3 border-b border-[#1f1f2b] flex items-center justify-between gap-2">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <span className="text-[10.5px] text-[#8a8a9c] tabular-nums">{filtered.length}</span>
        </div>
        <button
                ...
                return (
                  <button
                    ...
                    className={`inline-flex items-center gap-1.5 px-2 py-1 rounded-md text-[10.5px] font-medium border transition-colors ${
                      off
                        ? 'bg-transparent border-[#1f1f2b] text-[#8a8a9c]'
      ...
      <div className="flex-1 overflow-y-auto max-h-[480px]">
        {loading ? (
          ...
          <div className="p-8 text-center text-[11.5px] text-[#8a8a9c]">
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[10.5px] text-[#8a8a9c] mt-0.5 truncate font-mono">
                          {ev.ref || '—'}
                        </p>
                      </div>
                      <span className="text-[10px] text-[#8a8a9c] flex-shrink-0 mt-0.5 tabular-nums whitespace-nowrap">
                        {rel}
                      </span>
                    </button>
                  </motion.li>
