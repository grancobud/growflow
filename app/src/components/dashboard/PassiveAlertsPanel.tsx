    ...
    <div className="rounded-xl bg-[#101016] border border-[#1f1f2b] overflow-hidden">
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[10.5px] text-[#8a8a9c] mt-0.5 truncate">
            Silos sin actividad reciente
          </p>
        </div>
        <ChevronDown
          className={`w-4 h-4 text-[#8a8a9c] flex-shrink-0 transition-transform ${open ? 'rotate-180' : ''}`}
        />
      </button>
                  ...
                  <li key={a.id}>
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[10.5px] text-[#8a8a9c] mt-0.5">
                          {a.detail}
                        </p>
                      </div>
