...
//
// Cristian lo pidió el 02/09/2026 con el problema puesto: «hay veces que hay una
// merma, le pregunto a Hugo, no sacó, yo no saqué, no sabemos dónde va». Ese
...
// no pregunta quién se lo llevó. Hoy esa merma la absorbe Hugo como faltante de
