...
import { LayoutDashboard, LogOut, Sprout, Table2, BarChart3, KeyRound, Calculator, Building2, BookOpen, Scissors, Activity, CalendarDays, FlaskConical, CircuitBoard } from 'lucide-react'
...
type Item = {
   ...
   *
   * Panacea pidio que Econometria fuera un submenu de O.N.G. Se dibuja indentado
...
export default function Sidebar({ colapsado: colapsadoProp }: { colapsado?: boolean } = {}) {
  ...
  const todos: Item[] = [
    ...
    // GrowFlow conserva sus items de siempre: Cultivo, Cosecha y Ambiente abren
    // la misma pantalla (PaginaAgronomico) en su seccion.
    { nombre: 'Cultivo', ruta: '/sala', icono: Sprout, permiso: 'ver_cultivo',
      alias: ['/plantas', '/geneticas', '/linea-tiempo', '/cultivo', '/agronomico', '/plan'] },
    ...
    { nombre: 'Instalación', ruta: '/hardware-diy', icono: CircuitBoard, permiso: 'ver_plata',
      alias: ['/riego', '/tablero', '/insumos-faltantes', '/instalacion'] },
      ...
      <div className="px-3 sm:px-4 pt-4 pb-3.5 flex-shrink-0">
        <div className="flex items-center justify-center w-full">
          {/* Colapsado solo entra el isotipo; expandido, la marca apilada.
              ...
              lineas y el logo de Panacea queda pegado al borde derecho, sin
