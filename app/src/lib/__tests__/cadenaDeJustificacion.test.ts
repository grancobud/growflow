...
const BASE: DatosCadena = {
  ...
  // comen entero: 9000 g cobrados a $111 con material a $100 dan $99.000 de
  // margen contra $1.000.000 de gastos.
...
describe('produccion propia contada como compra a terceros', () => {
  // El caso real de Panacea, 28/08/2026. Los dos son el MISMO error conceptual
...
describe('cadenaDeJustificacion', () => {
  ...
  it('comprar el material NO es un error en sí: lo que falta es su respaldo', () => {
    ...
    // material no salió del cultivo propio, la cadena se rompía. Panacea contó
  ...
  //
  // Panacea nunca cultivo: todo lo que entrego lo compro a proveedores y lo
  ...
  it('lo que se le debe a proveedores cuenta como costo', () => {
    // El caso de Panacea al 23/08/2026: la caja mostraba $8,8 M de excedente y
    // al mismo tiempo habia ~$32 M sin pagarle a proveedores. Mirando solo lo
...
describe('margen', () => {
  it('cierra cuando el margen sobre el material no alcanza a cubrir los gastos', () => {
    // El caso real de Panacea: se cobran $9.872 por gramo y el material cuesta
    // $8.156. Los $11 M de diferencia no llegan a los $47,3 M de gastos, así que
  ...
  it('no divide el aporte entre los gramos entregados sin cargo', () => {
    ...
    // el precio por gramo baja de $9.871 a $7.164 y el margen se ve negativo:
