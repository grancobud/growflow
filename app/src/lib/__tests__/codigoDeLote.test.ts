...
/**
 * Los 14 primeros códigos REALES de Panacea, tal cual están en la base.
 *
...
describe('proximoCodigoDeLote', () => {
  ...
  it('ignora los códigos de Panacea para el cálculo, pero no los toca', () => {
    ...
    expect(proximoCodigoDeLote(PANACEA)).toBe('LOTE-001')
    expect(proximoCodigoDeLote([...PANACEA, 'LOTE-004'])).toBe('LOTE-005')
  })
