...
// Proyecto Panacea se llamaban `PA-A #1`…`PA-A #45` y `PA-B #1`…`PA-B #15`, y esa
...
// "[Lote] Proyecto Panacea - siembra", "[Grupo A] Fase de consolidación…".
...
export interface EventoConNivel extends Evento {
  ...
  lote_id?: string | null
  nivel: NivelEvento
  /** "Grupo A" o "Proyecto Panacea", para el cartelito de la fila. */
...
export const gruposService = {
   ...
   *
   * Es el punto de B2: regar las 60 plantas del Proyecto Panacea generaba 60
