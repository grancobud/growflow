...
// DE DONDE SALE ESTO
//
// Se lo planteo a Panacea gente de Bruma Fitomedicina, y es la respuesta a la
...
export interface DatosCadena {
   ...
   *
   * Panacea a veces cultiva y a veces compra. El material comprado no se
   ...
   * Metidos en `gramosComprados`, la nota decia «9.147 g de proveedores» cuando
   ...
   * Mirando solo la caja, Panacea mostraba $8,8 M de excedente el 23/08/2026 y al
...
export function cadenaDeJustificacion(d: DatosCadena): Eslabon[] {
  ...
  // detrás — en Panacea, 4.837 g contra 100 registrados—, que es el que más
