...
//    referido de Panacea. Se marca como opcional y aparte del tramite oficial:
...
export const PASOS_ALTA: PasoAlta[] = [
  ...
  },
  {
    ...
    url: 'https://repronline.cannis.org/referidos/panaceacompany',
 ...
 *
 * Panacea lo corrigió y el flujo real es otro: escriben por WhatsApp o Instagram,
