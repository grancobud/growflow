...
export const SALES_DEFECTO: Sal[] = [
  ...
  { id: 'aminoacidos', nombre: 'Aminoácidos (L-aminoácidos, polvo)', formula: 'aminoácidos', bidon: 'C', aditivo: true, comp: {},
    descripcion: 'Bioestimulante en POLVO: L-aminoácidos libres (hidrólisis enzimática). Mejora fotosíntesis, recuperación de estrés y absorción; quela micros. Dosis foliar/riego ~0,5–1 g/L. Materia prima pura en Pura Química (x kg). Sustituto de la "proteína de leche" de boosters como Green Sensation.' },
