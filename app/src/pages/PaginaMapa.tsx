      ...
      <div className="sticky top-0 z-40 bg-[#0a0a0f]/95 backdrop-blur-[2px] border-b border-[#1f1f2b]">
        <div className="flex items-center gap-2 sm:gap-4 px-3 sm:px-6 py-3">
          <div className="min-w-0">
            ...
            <div className="mt-0.5 text-[10.5px] sm:text-[11px] text-[#8a8a9c]"><span className="hidden sm:inline">Plano fisico FIS S.A.S. · </span>Clickea un area para ver lotes</div>
          </div>
          ...
          <>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              {[
                ...
                <div key={i} className="rounded-xl bg-[#101016] border border-[#1f1f2b] p-4">
                  ...
                  <div className="mt-1 text-[11px] text-[#8a8a9c]">{k.hint}</div>
                </div>
              ))}
            </div>
            ...
            <div className="rounded-xl bg-[#101016] border border-[#1f1f2b] p-5 overflow-x-auto">
              <div className="flex items-baseline justify-between mb-4">
                ...
                <div className="flex items-center gap-2 text-[10.5px] text-[#8a8a9c]">
            ...
            <div className="rounded-xl bg-[#101016] border border-[#1f1f2b] p-5">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-[10.5px] text-[#8a8a9c] font-mono ml-auto">{datos.instalaciones.length} totales</span>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
                {datos.instalaciones.map(i => (
                  <div key={i.id} className="bg-[#15151d] border border-[#1f1f2b] rounded-lg p-3 text-[12px] hover:border-[#a3e635]/30 transition-colors">
                    ...
                    <div className="text-[10px] text-[#8a8a9c] mt-0.5 font-mono">{i.codigo} · {i.tipo}</div>
                    <div className="flex gap-3 mt-2 text-[10.5px]">
                      <span className="text-[#8a8a9c]">Lotes <span className="text-[#d9f99d] font-mono font-semibold">{i.lotes_activos}</span></span>
                      <span className="text-[#8a8a9c]">Unid <span className="text-[#c4b5fd] font-mono font-semibold">{i.total_unidades}</span></span>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <motion.div initial={{ x: '100%' }} animate={{ x: 0 }} exit={{ x: '100%' }}
                ...
                <div className="px-5 py-4 border-b border-[#1f1f2b] bg-[#15151d] flex items-center justify-between">
                  <div className="min-w-0">
                    ...
                    <p className="text-[10.5px] text-[#8a8a9c] mt-1 font-mono">{lotes} lote{lotes === 1 ? '' : 's'} · {area.cumcs?.length || 0} CUMCS asociados</p>
                  </div>
                ...
                <div className="p-5 space-y-4">
                  ...
                  <div>
                    ...
                    {detalle.length === 0 ? (
                      <div className="text-center py-8 text-[#8a8a9c] text-[11px]">Sin lotes activos en esta area.</div>
                    ) : (
                      <table className="w-full text-[11px]">
                        <thead>
                          <tr className="text-[#8a8a9c] text-left border-b border-[#1f1f2b]">
