  ...
  return (
    <div className="flex-1 overflow-hidden flex flex-col bg-[#0a0a0f] text-[#d4d4dd] font-sans">
        ...
        <div className="flex items-center gap-2 sm:gap-4 px-3 sm:px-6 py-3">
          <div className="min-w-0 flex items-center gap-2.5">
            ...
            <div className="min-w-0">
              ...
              <div className="mt-1 text-[10.5px] sm:text-[11px] text-[#8a8a9c] hidden sm:block">Cadena seed-to-sale visual · datos reales por camada</div>
            </div>
          </div>
      ...
      <div className="px-3 sm:px-6 py-3 border-b border-[#1f1f2b] flex items-center gap-2 sm:gap-3 flex-wrap bg-[#0a0a0f] flex-shrink-0">
        <span className="text-[10px] uppercase tracking-[0.16em] text-[#8a8a9c] font-medium">Camada</span>
        ...
        {!cargando && totalLotes > 0 && (
          <div className="text-[11px] text-[#8a8a9c]">
      ...
      {!cargando && etapasUsadas.length > 0 && (
        <div className="px-3 sm:px-6 py-2.5 border-b border-[#1f1f2b] flex items-center gap-2 flex-nowrap bg-[#0a0a0f] overflow-x-auto flex-shrink-0">
          <span className="text-[10px] uppercase tracking-[0.16em] text-[#8a8a9c] font-medium mr-1 shrink-0">Etapas</span>
          {etapasUsadas.map(e => {
            ...
            return (
              <div key={e.orden} className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-md border shrink-0"
                ...
                <span className="font-mono text-[10px] text-[#8a8a9c] tabular-nums">{e.count}</span>
              </div>
            )
          })}
        </div>
      ...
      {cargando && (
        <div className="flex-1 flex items-center justify-center">
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3, ease: EASE }}
            className="flex flex-col items-center gap-3 text-[#8a8a9c]">
      ...
      {!cargando && nodes.length === 0 && (
        <div className="flex-1 flex items-center justify-center">
          <div className="flex flex-col items-center gap-3 text-[#8a8a9c] text-[12px]">
            <Sprout className="w-7 h-7 text-[#8a8a9c]" />
