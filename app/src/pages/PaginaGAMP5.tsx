      ...
      <div className="flex-1 overflow-y-auto bg-[#0a0a0f] text-[#d4d4dd] font-sans ct-page-scroll">
        ...
        <div className="px-3 sm:px-6 py-4 sm:py-5 pb-20 space-y-4 sm:space-y-5">
          ...
          <div className="rounded-xl bg-[#101016] border border-[#1f1f2b] p-5">
            ...
            <p className="text-[10.5px] text-[#7d7d8e] mt-4 italic">
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[11px] text-[#7d7d8e] mb-2 leading-relaxed">{doc.desc}</p>
    ...
    return (
      <div className="flex-1 overflow-y-auto bg-[#0a0a0f] text-[#d4d4dd] font-sans ct-page-scroll">
        <div className="flex-1 flex items-center justify-center py-20">
          <p className="text-[#7d7d8e]">El documento {docId} no existe.</p>
        </div>
      </div>
    )
  }
      ...
      <div className="px-3 sm:px-6 py-4 sm:py-5 pb-20 space-y-4 sm:space-y-5">
        ...
        <div className="rounded-xl bg-[#101016] border border-[#1f1f2b] p-5 space-y-5">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-[11px] text-[#7d7d8e]">{doc.referencia}</span>
          ...
          <div className="p-4 bg-[#15151d] rounded-xl border border-[#1f1f2b]">
            <p className="text-[10px] uppercase tracking-[0.14em] text-[#7d7d8e] font-medium mb-2">Que es este documento</p>
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="p-3 bg-[#15151d] rounded-xl border border-[#1f1f2b] text-center">
              <Database className="w-5 h-5 text-[#7d7d8e] mx-auto mb-1" />
              <p className="text-[11px] font-medium text-[#d4d4dd]">23 tablas</p>
              <p className="text-[10px] text-[#7d7d8e]">con RLS activo</p>
            </div>
            <div className="p-3 bg-[#15151d] rounded-xl border border-[#1f1f2b] text-center">
              <Lock className="w-5 h-5 text-[#7d7d8e] mx-auto mb-1" />
              <p className="text-[11px] font-medium text-[#d4d4dd]">4 roles</p>
              <p className="text-[10px] text-[#7d7d8e]">con permisos</p>
            </div>
            <div className="p-3 bg-[#15151d] rounded-xl border border-[#1f1f2b] text-center">
              <Shield className="w-5 h-5 text-[#7d7d8e] mx-auto mb-1" />
              <p className="text-[11px] font-medium text-[#d4d4dd]">SHA-256</p>
              <p className="text-[10px] text-[#7d7d8e]">audit trail</p>
            </div>
          </div>
        </div>
      </div>
