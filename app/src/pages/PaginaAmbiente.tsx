// PaginaAmbiente — el ambiente de la sala.
//
// Cuatro pestanas: En vivo (los sensores de Growcast por el worker
// growcast-bridge, con las automatizaciones y recomendaciones por etapa), Cargar
// (lecturas manuales con el termohigrometro, para cuando no hay sensor o para
// dejar asentado), Analisis (lo que esos datos significan) y Salas.
//
...
import AmbienteEnVivo from '../components/ambiente/AmbienteEnVivo'
...
type Tab = 'envivo' | 'cargar' | 'analisis' | 'salas'
...
export default function PaginaAmbiente() {
  const [tab, setTab] = useState<Tab>('envivo')
