        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-[10.5px] text-[#8a8a9c]">PDF emitido por laboratorio acreditado</p>
            </div>
          </div>
          ...
          >
            {procesando ? (
              <>
                ...
                <p className="text-[10.5px] text-[#8a8a9c]">Extrayendo texto + parseando</p>
              </>
            ) : (
              <>
                ...
                <p className="text-[10.5px] text-[#8a8a9c]">o arrastra aqui</p>
          ...
          >
            ...
            <div className="rounded-xl bg-[#101016] border border-[#1f1f2b] p-4 space-y-3">
              <div>
                ...
                <p className="text-[10.5px] text-[#8a8a9c] mt-0.5">Asocia el CoA a un lote para la traza publica y auditoria.</p>
              </div>
