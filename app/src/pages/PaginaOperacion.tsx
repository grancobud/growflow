...
function TabLoader({ label = 'Cargando…' }: { label?: string }) {
  return (
    <div className="flex flex-col items-center justify-center py-20 gap-3">
      ...
      <p className="text-[11.5px] text-[#8a8a9c] font-mono tabular-nums">{label}</p>
    </div>
  )
}
      ...
      <div className="ct-op-wrap flex-1 overflow-y-auto ct-page-scroll bg-[#0a0a0f] text-[#d4d4dd] font-sans">
        ...
        <div className="px-3 sm:px-6 py-3 sm:py-5 space-y-3 sm:space-y-4 pb-20">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <div className="hidden sm:block text-[11px] text-[#8a8a9c] ml-auto">
          ...
          <footer className="pt-4 sm:pt-6 mt-2 border-t border-[#1f1f2b] text-[10.5px] sm:text-[11px] text-[#8a8a9c] flex items-center justify-between flex-wrap gap-2">
