      ...
      <div className="sticky top-0 z-40 bg-[#0a0a0f]/95 backdrop-blur-[2px] border-b border-[#1f1f2b]">
        <div className="flex items-center flex-wrap gap-2 sm:gap-x-4 px-3 sm:px-6 py-3">
          <div className="min-w-0">
            ...
            <div className="mt-0.5 text-[10.5px] sm:text-[11px] text-[#8a8a9c]">{geneticas.length} en el banco</div>
          </div>
      ...
      <div className="px-3 sm:px-6 py-4 pb-20">
        {cargando ? (
          ...
          <div className="py-16 text-center">
            ...
            <div className="mt-1 text-[11.5px] text-[#8a8a9c]">{geneticas.length === 0 ? 'Creá la primera ficha de genética.' : 'Probá con otra búsqueda.'}</div>
          </div>
        ) : (
                  ...
                  <div className="p-4 flex flex-col flex-1">
                    <div className="flex items-start gap-2">
                      <div className="min-w-0 flex-1">
                        <button onClick={() => { setEditar(g); setModalForm(true) }}
                          className={`font-display font-semibold text-[14px] text-[#ececf1] truncate hover:text-[#bef264] transition-colors text-left block max-w-full ${nombreTocable}`} title="Ver / editar ficha">
                          {g.nombre}
                        </button>
                    ...
                    {g.usos_medicinales && (
                      <div className="mt-2.5 pt-2.5 border-t border-[#1f1f2b]">
                        <span className="text-[9.5px] uppercase tracking-[0.14em] text-[#8a8a9c]">Usos</span>
                    ...
                    <div className="mt-auto pt-3 flex gap-1.5">
                      ...
                      <button onClick={() => borrar(g)} className="min-h-[44px] min-w-[44px] sm:min-h-0 sm:min-w-0 p-1.5 text-[#8a8a9c] hover:text-[#ff8a7a] hover:bg-[#15151d] rounded-lg transition-colors ml-auto" title="Borrar"><Trash2 className="w-3.5 h-3.5" /></button>
                    </div>
                  </div>
                </div>
              )
  ...
  return (
    <Modal titulo={`Ficha: ${g.nombre}`} onCerrar={onCerrar}>
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-2 flex-wrap text-[11.5px] text-[#8a8a9c]">
