  ...
  if (!entidad) {
    return (
      <div className={`${card} text-center py-12`}>
        ...
        <p className="mt-1 text-[11.5px] text-[#8a8a9c] max-w-md mx-auto">
  ...
  return (
    <div className="space-y-4">
              ...
              <div key={v.clave} className="rounded-lg bg-[#15151d] border border-[#1f1f2b] px-3 py-2.5">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <span className="ml-auto text-[12.5px] font-mono tabular-nums" style={{ color: c.txt }}>
                    {fmtFecha(v.fecha)} <span className="text-[#8a8a9c]">· {textoDias(v.dias)}</span>
                  </span>
                </div>
          ...
          {capacidad.map(l => {
            ...
            return (
              <div key={l.titulo}>
                ...
                <p className="text-[10.5px] text-[#8a8a9c] mt-1">{l.detalle}</p>
                {excedido && (
      ...
      <div className={card}>
        ...
        <p className="text-[11.5px] text-[#8a8a9c] mb-3">Lo que hay que tener para pedir el botón de REPROCANN.</p>
      ...
      <div className={card}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <label><span className={labelCls}>Vencimiento</span>
            ...
            <span className="block text-[10.5px] text-[#8a8a9c] mt-1">
            ...
            <div key={a.id} className={card}>
              <div className="flex items-start gap-2">
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-[10.5px] text-[#8a8a9c] mt-0.5">{a.organo}</p>
                </div>
        ...
        <Modal titulo={form.id ? 'Editar autoridad' : 'Nueva autoridad'} onCerrar={() => setForm(null)}>
          <div className="space-y-3">
            ...
            <label><span className={labelCls}>Grupo familiar</span>
              ...
              <span className="block text-[10.5px] text-[#8a8a9c] mt-1 leading-snug">
            ...
            <div key={p.id} className={card}>
              <div className="flex items-start gap-2">
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-[11.5px] text-[#8a8a9c] mt-0.5 truncate">
