              ...
              <div className="relative grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8 items-center">
                ...
                {stockSparkline.length > 1 && !cargando && (
                  <div className="lg:col-span-2">
                    <p className="text-[10.5px] uppercase tracking-[0.16em] text-[#8a8a9c] font-medium mb-2">
      ...
      <div className="flex items-end justify-between gap-3 mb-3 sm:mb-4 flex-wrap">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            {subtitle && <p className="text-[10.5px] sm:text-[11px] text-[#8a8a9c] mt-0.5">{subtitle}</p>}
          </div>
        </div>
      </div>
      {children}
...
function HeroFact({ label, value }: { label: string; value: string | number }) {
  return (
    <div className="flex items-baseline gap-1.5">
      ...
      <span className="text-[10.5px] sm:text-[11px] text-[#8a8a9c]">{label}</span>
    </div>
  )
}
      ...
      <div className="relative rounded-xl bg-[#101016] border border-[#1f1f2b] hover:border-[#404d20] transition-all p-5 sm:p-6 h-full overflow-hidden group">
        ...
        <div className="relative">
          <div className="flex items-center justify-between mb-3">
            <p className="text-[10.5px] uppercase tracking-[0.16em] text-[#8a8a9c] font-semibold">{label}</p>
          ...
          <p className="text-[11.5px] text-[#8a8a9c] mt-3">{hint}</p>
        </div>
      </div>
    </motion.div>
  )
      ...
      <div className="rounded-xl bg-[#101016] border border-[#1f1f2b] p-5">
        <div className="flex items-start gap-2.5 mb-1">
          ...
          <div className="min-w-0">
            ...
            {subtitulo && <p className="text-[10.5px] text-[#8a8a9c] mt-0.5">{subtitulo}</p>}
          </div>
        </div>
        {children}
      </div>
