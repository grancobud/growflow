            ...
            >
              <div className="rounded-xl bg-[#101016] border border-[#404d20] p-5 space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <button onClick={() => setNuevoOpen(false)} className="p-1 text-[#8a8a9c] hover:text-[#d4d4dd] rounded" aria-label="Cerrar">
                    <X className="w-4 h-4" />
                  </button>
                </div>
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-3 py-2 bg-[#0a0a0f] border border-[#1f1f2b] focus:border-[#404d20] rounded-md text-[12px] text-[#ececf1] placeholder:text-[#8a8a9c] font-mono outline-none transition-colors resize-none"
                />
              ...
              >
                <div className="flex items-center gap-3 mb-3 flex-wrap">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-[11.5px] text-[#8a8a9c] truncate">{versiones[0].titulo}</p>
                  </div>
                  <span className="text-[10.5px] text-[#8a8a9c] tabular-nums flex-shrink-0">
                ...
                <ul className="space-y-1.5">
                  {versiones.map((v) => (
                    ...
                    >
                      ...
                      {v.fecha_vigencia && (
                        <span className="text-[#8a8a9c] tabular-nums">
                          Vigente desde {v.fecha_vigencia}
                        </span>
                      )}
                      <span className="text-[#8a8a9c] tabular-nums ml-auto">
...
function SOPInput({ value, onChange, placeholder }: { value: string; onChange: (v: string) => void; placeholder: string }) {
  return (
    <input
      ...
      className="w-full px-3 py-2 bg-[#0a0a0f] border border-[#1f1f2b] focus:border-[#404d20] rounded-md text-[12.5px] text-[#ececf1] placeholder:text-[#8a8a9c] outline-none transition-colors"
    />
  )
}
