...
export default function PaginaRiego() {
  ...
  const tabBtn = (activo: boolean) =>
    `flex items-center gap-1.5 text-[12px] px-3 py-1.5 min-h-[44px] sm:min-h-0 rounded-md border transition-colors ${activo
  ...
  return (
    <div className="flex-1 overflow-y-auto overflow-x-hidden bg-[#0a0a0f] text-[#d4d4dd] font-sans ct-page-scroll">
      ...
      <div className="sticky top-0 z-40 bg-[#0a0a0f]/95 backdrop-blur-[2px] border-b border-[#1f1f2b]">
        ...
        <div className="flex items-center gap-2 px-3 sm:px-6 pb-2 w-full">
