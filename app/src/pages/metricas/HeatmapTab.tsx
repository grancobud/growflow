    ...
    >
      ...
      <div className="p-2 sm:p-4">
        ...
        <div className="mt-3 flex items-center justify-end gap-2">
          <span className="text-[10px] uppercase tracking-[0.14em] text-[#8a8a9c] font-medium">menos</span>
          <div
          ...
          />
          <span className="text-[10px] uppercase tracking-[0.14em] text-[#8a8a9c] font-medium">más</span>
        </div>
      </div>
    </motion.div>
  )
