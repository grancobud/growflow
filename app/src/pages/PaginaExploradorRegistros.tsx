      ...
      <div className="sticky top-0 z-40 bg-[#0a0a0f]/95 backdrop-blur-[2px] border-b border-[#1f1f2b]">
        <div className="flex items-center gap-2 sm:gap-4 px-3 sm:px-6 py-3">
          ...
          <div className="min-w-0">
            ...
            <div className="mt-0.5 text-[10.5px] sm:text-[11px] text-[#8a8a9c]">Vista admin · edicion + firma 21 CFR Part 11</div>
          </div>
                ...
                <button
                  ...
                  className={`relative flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[11px] font-medium whitespace-nowrap transition-colors flex-shrink-0 ${
                    activa
                      ...
                      : 'text-[#8a8a9c] hover:text-[#b3b3c0] hover:bg-[#15151d]'
                  }`}
      ...
      <div className="px-3 sm:px-6 py-4 sm:py-5 pb-20 space-y-4">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-[#8a8a9c] font-mono">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <button
              ...
              title="Refrescar"
            >
              <RefreshCcw className={`w-3.5 h-3.5 text-[#8a8a9c] ${cargando ? 'animate-spin' : ''}`} />
            </button>
            <button
        ...
        <div className="bg-[#101016] border border-[#1f1f2b] rounded-xl overflow-hidden">
          <DataTable
            ...
            emptyState={
              cargando ? (
                <div className="flex items-center justify-center gap-2 py-12 text-[#8a8a9c]">
                  <RefreshCcw className="w-4 h-4 animate-spin" /> Cargando registros...
                </div>
              ) : (
                <div className="text-center py-12 text-[#8a8a9c]">
      ...
      >
        ...
        <div className="px-5 py-4 border-b border-[#1f1f2b] flex items-center justify-between gap-3">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[10px] text-[#8a8a9c] font-mono truncate">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            {!editando ? (
              ...
              <button
                ...
                className="px-3 py-1.5 text-xs text-[#8a8a9c] hover:text-[#ff8a7a] transition-colors"
              >
                Cancelar
              </button>
            )}
            <button
              onClick={onClose}
              className="p-1.5 text-[#8a8a9c] hover:text-[#d4d4dd] transition-colors"
              aria-label="Cerrar"
            >
              <X className="w-4 h-4" />
            </button>
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-4">
            ...
            {camposOrdenados.map(k => {
              ...
              return (
                <div key={k} className="grid grid-cols-[130px_1fr] gap-3 items-start py-1.5 border-b border-[#1f1f2b]/60">
                  <div className="text-[11px] text-[#8a8a9c] pt-1.5 flex items-center gap-1">
                    {prettyLabel(k)}
          ...
          {registro.datos_extra != null && typeof registro.datos_extra === 'object' && (
            <div>
              <p className="text-[10px] uppercase tracking-[0.14em] text-[#8a8a9c] font-medium mb-2">datos_extra</p>
      ...
      >
        ...
        <div className="flex items-center gap-3 p-4 border-b border-[#1f1f2b]">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-[11px] text-[#8a8a9c]">Full-text castellano sobre todos los registros (pgroonga)</p>
          </div>
          <button onClick={onClose} className="p-1.5 hover:bg-[#15151d] rounded-lg transition-colors">
            <X className="w-4 h-4 text-[#8a8a9c]" />
          </button>
        </div>
        ...
        <form onSubmit={buscar} className="p-4 border-b border-[#1f1f2b]">
          <div className="relative">
            ...
            <input
              ...
              autoFocus
              className="w-full pl-9 pr-24 py-2.5 bg-[#15151d] border border-[#2a2a3a] rounded-lg text-sm text-[#d4d4dd] placeholder-[#8a8a9c] focus:outline-none focus:ring-1 focus:ring-[#a3e635]/30 focus:border-[#404d20]"
            />
            <button
              type="submit"
          ...
          {resultados.map((r, i) => (
            ...
            >
              <div className="flex items-start justify-between gap-3 mb-1.5">
                ...
                <span className="text-[10px] text-[#8a8a9c] font-mono tabular-nums flex-shrink-0">
