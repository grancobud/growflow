    ...
    <div className="flex-1 overflow-y-auto bg-[#0a0a0f] text-[#d4d4dd] font-sans ct-page-scroll">
      ...
      <div className="sticky top-0 z-40 bg-[#0a0a0f]/95 backdrop-blur-[2px] border-b border-[#1f1f2b]">
        <div className="flex items-center gap-2 sm:gap-4 px-3 sm:px-6 py-3">
          ...
          <div className="min-w-0">
            ...
            <div className="mt-0.5 text-[10.5px] sm:text-[11px] text-[#8a8a9c]">{tipos.length} planillas · 10 grupos · <span className="hidden sm:inline">conservacion 7 años</span></div>
          </div>
      ...
      <div className="px-3 sm:px-6 py-4 sm:py-5 pb-20 space-y-4 sm:space-y-5">
        ...
        {(areaFiltro !== 'todas' || grupoFiltro !== 'todos') && !busqueda && (
          <div className="flex items-center gap-2 text-xs text-[#8a8a9c]">
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-[10px] font-semibold text-[#8a8a9c] tracking-widest uppercase">{area.grupos.length} grupos</span>
                  </div>
                  ...
                  <p className="text-[10px] text-[#8a8a9c] mt-2">{count} registros</p>
                </button>
              )
            })}
          </div>
              ...
              {area.grupos.map(g => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="text-[10px] text-[#8a8a9c] mt-1">{count} reg · {obligatorios} oblig</p>
                  </button>
                )
              })}
            </div>
        ...
        {cargando ? (
          <div className="text-center py-12">
            ...
            <p className="mt-3 text-sm text-[#8a8a9c]">Cargando registros CUMCS...</p>
          </div>
        ) : !mostrarLista ? null : (
            ...
            const renderItem = (reg: TipoRegistro, last: boolean) => (
              ...
              >
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[11px] text-[#8a8a9c] hidden sm:block">{reg.conservacion}</p>
                </div>
                ...
                <ChevronRight className="w-4 h-4 text-[#8a8a9c] flex-shrink-0" />
              </div>
            )
            ...
            return (
              <div key={grupo}>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-xs text-[#8a8a9c]">({registros.length})</span>
                </div>
                ...
                {busqueda || porSub.length === 0 ? (
                  ...
                  <div className="space-y-3">
                    {porSub.map(sub => (
                      <div key={sub.nombre}>
                        <p className="text-[10px] font-semibold text-[#8a8a9c] uppercase tracking-[0.14em] mb-1.5 pl-1">{sub.nombre}</p>
                        <div className="bg-[#101016] rounded-xl border border-[#1f1f2b] overflow-hidden">
        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-end sm:items-center justify-center z-50 p-0 sm:p-4" onClick={() => setRegistroActivo(null)}>
          <div className="bg-[#101016] border border-[#1f1f2b] rounded-t-2xl sm:rounded-2xl w-full sm:max-w-lg max-h-[90vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
            ...
            <div className="px-5 py-4 border-b border-[#1f1f2b] flex items-start justify-between gap-3">
              ...
              <button onClick={() => setRegistroActivo(null)} className="p-1.5 rounded-lg hover:bg-[#1c1c27] text-[#8a8a9c] hover:text-[#d4d4dd] transition-colors flex-shrink-0">
                <X className="w-4 h-4" />
              </button>
            </div>
            ...
            <div className="p-5 space-y-4">
              ...
              <div>
                <label className="block text-[10px] uppercase tracking-[0.14em] text-[#8a8a9c] font-medium mb-1.5">Fecha</label>
              ...
              <div>
                <label className="block text-[10px] uppercase tracking-[0.14em] text-[#8a8a9c] font-medium mb-1.5">Responsable *</label>
                <input type="text" value={formResponsable} onChange={e => setFormResponsable(e.target.value)} placeholder="Nombre del responsable"
                  className="w-full px-3 py-2.5 bg-[#15151d] border border-[#2a2a3a] rounded-lg text-sm text-[#d4d4dd] placeholder-[#8a8a9c] focus:outline-none focus:ring-1 focus:ring-[#a3e635]/30 focus:border-[#404d20]" />
              </div>
              ...
              <div>
                <label className="block text-[10px] uppercase tracking-[0.14em] text-[#8a8a9c] font-medium mb-1.5">Observaciones</label>
                <textarea rows={3} placeholder="Observaciones adicionales..." value={formObs} onChange={e => setFormObs(e.target.value)}
                  className="w-full px-3 py-2.5 bg-[#15151d] border border-[#2a2a3a] rounded-lg text-sm text-[#d4d4dd] placeholder-[#8a8a9c] focus:outline-none focus:ring-1 focus:ring-[#a3e635]/30 focus:border-[#404d20] resize-none" />
              </div>

              {/* Info GAMP5 */}
              <div className="p-3 bg-[#15151d] border border-[#1f1f2b] rounded-xl text-[11px] text-[#8a8a9c] space-y-1">
