...
export default function PaginaSala() {
   ...
   * de Panacea creo «Sala 1» en Ambiente, fue a Plantas y no le aparecia — la app
  ...
  // el instrumento de Panacea; el ppm se deriva.
   ...
   *
   * Es el punto de B2. Regar las 60 del Proyecto Panacea eran 120 filas —hay 600
