          ...
          <button
            ...
            className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full border text-[10.5px] uppercase tracking-widest font-medium transition-colors ${
              mostrarCodigos
                ...
                : 'border-[#1f1f2b] bg-transparent text-[#8a8a9c] hover:text-[#d9f99d] hover:border-[#a3e635]/30'
            }`}
      ...
      <div className="px-3 sm:px-6 py-4 sm:py-5 pb-20 space-y-4 sm:space-y-5">
        ...
        <div className="rounded-xl bg-[#101016] border border-[#1f1f2b] p-5 print-page-break no-print">
          ...
          <div className="flex items-center gap-6 flex-wrap">
            ...
            <div className="flex gap-5">
              <div className="text-center"><p className="text-[22px] font-bold font-display text-[#a3e635] tabular-nums">{totalOk}</p><p className="text-[10px] text-[#8a8a9c] uppercase tracking-[0.12em]">Correctos</p></div>
              <div className="text-center"><p className="text-[22px] font-bold font-display text-[#c4b5fd] tabular-nums">{totalAlerta}</p><p className="text-[10px] text-[#8a8a9c] uppercase tracking-[0.12em]">Alertas</p></div>
              <div className="text-center"><p className="text-[22px] font-bold font-display text-[#ff8a7a] tabular-nums">{totalFallo}</p><p className="text-[10px] text-[#8a8a9c] uppercase tracking-[0.12em]">Fallos</p></div>
              <div className="text-center"><p className="text-[22px] font-bold font-display text-[#8a8a9c] tabular-nums">{checks.length}</p><p className="text-[10px] text-[#8a8a9c] uppercase tracking-[0.12em]">Total</p></div>
            </div>
          </div>
        </div>
        ...
        {ejecutando ? (
          <div className="text-center py-12 no-print">
            ...
            <p className="mt-3 text-[12.5px] text-[#8a8a9c]">Ejecutando verificaciones...</p>
          </div>
        ) : (
              ...
              return (
                <div key={cat} className="rounded-xl bg-[#101016] border border-[#1f1f2b] overflow-hidden print-block no-print">
                  <div className="px-4 py-3 bg-[#15151d] border-b border-[#1f1f2b] flex items-center justify-between">
                    ...
                    <span className="text-[10.5px] text-[#8a8a9c] tabular-nums">{okCat}/{checksCategoria.length} OK</span>
                  </div>
                      ...
                      return (
                        <div key={check.id} className="px-4 py-3 print-page-break">
                          <div className="flex items-start gap-3">
                            ...
                            {Icono && <Icono className="w-4 h-4 text-[#8a8a9c] flex-shrink-0 mt-1 no-print" strokeWidth={1.75} />}
                            <div className="flex-1 min-w-0">
                              <p className="text-[12.5px] font-medium text-[#d4d4dd]">{check.nombre}</p>
                              <p className="text-[11px] text-[#8a8a9c] mt-0.5 leading-snug">{check.detalle}</p>
                            </div>
                            {mostrarCodigos && (
                              <span className="text-[10px] font-mono text-[#8a8a9c] flex-shrink-0 mt-1">{check.referencia}</span>
                            )}
                          </div>
