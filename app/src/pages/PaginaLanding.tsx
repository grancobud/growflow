            ...
            <motion.div variants={stagger}
              ...
              {[
                ...
                <motion.div key={s.label} variants={fadeUp}
                  ...
                  <p className="text-[9.5px] uppercase tracking-[0.14em] text-[#8a8a9c] font-medium">{s.label}</p>
                  <p className="font-display font-bold tabular-nums text-[20px] sm:text-[24px] mt-1 leading-none" style={{ color: s.color }}>{s.valor}</p>
                  <p className="text-[10.5px] text-[#8a8a9c] mt-1">{s.hint}</p>
                </motion.div>
              ))}
            </motion.div>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto px-3 sm:px-6 py-10 sm:py-12">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
            <div className="col-span-2">
              ...
              <div className="mt-3 flex items-center gap-1.5 text-[10.5px] text-[#8a8a9c]">
            ...
            <div>
              <h4 className="text-[10px] font-medium uppercase tracking-[0.14em] text-[#8a8a9c] mb-3">Producto</h4>
            ...
            <div>
              <h4 className="text-[10px] font-medium uppercase tracking-[0.14em] text-[#8a8a9c] mb-3">Empresa</h4>
              <ul className="space-y-2 text-[12px]">
          ...
          <div className="mt-10 pt-5 border-t border-[#1f1f2b] flex items-center justify-between flex-wrap gap-3 text-[10.5px] text-[#8a8a9c]">
